  ...
  return (
    <div className="flex items-center justify-center gap-3">
      <button
        ...
        className="rounded-full bg-accent px-6 py-2 text-sm font-medium text-white outline-none transition-colors focus-visible:ring-2 focus-visible:ring-accent"
      >
        {primaryLabel}
      </button>
      <button
